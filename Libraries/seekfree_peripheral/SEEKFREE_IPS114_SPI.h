...
//PERIPHERAL_PIN_SWITCH的值可以在board.h文件中修改
	...
	#define IPS114_REST_SIMSPI_PIN  	P32
	#define IPS114_DC_SIMSPI_PIN 	 	P33   	//液晶命令位引脚定义
	#define IPS114_CS_SIMSPI_PIN    	P35   	//定义SPI_CS引脚
	#define IPS114_BL_SIMSPI_PIN    	P36     //液晶背光引脚定义  
